...
object Fonts : MinecraftInstance {
    ...
    fun loadFonts() {
        ...
        val time = measureTimeMillis {
            ...
            fontRegular30 = register(
                ...
                getFontFromFile("font.ttf", 30).asGameFontRenderer()
            )

            fontSemibold35 = register(
                FontInfo(name = "Outfit Semibold", size = 35),
                getFontFromFile("font.ttf", 35).asGameFontRenderer()
            )
            ...
            fontRegular40 = register(
                ...
                getFontFromFile("font.ttf", 40).asGameFontRenderer()
            )
            ...
            fontRegular45 = register(
                ...
                getFontFromFile("font.ttf", 45).asGameFontRenderer()
            )
            ...
            fontBold180 = register(
                ...
                getFontFromFile("font.ttf", 180).asGameFontRenderer()
            )
    ...
    fun downloadFonts() {
        ...
        if (!outputFile.exists()) {
            ...
            Downloader.downloadWholeFile("https://raw.githubusercontent.com/testaccount11262/ShadeCloud/refs/heads/main/Outfit.zip", outputFile)
