...
import net.ccbluex.liquidbounce.features.module.modules.movement.flymodes.other.intaveFlagFly
import net.ccbluex.liquidbounce.features.module.modules.movement.flymodes.other.TeleportFly
import net.ccbluex.liquidbounce.features.module.modules.movement.flymodes.other.betterintaveflagfly
...
object Fly : Module("Fly", Category.MOVEMENT, Keyboard.KEY_F) {
    private val flyModes = arrayOf(
        ...
        // Other
        Jetpack, KeepAlive, Collide, Jump, Flag, Fireball, intaveFlagFly, TeleportFly, betterintaveflagfly
    )
