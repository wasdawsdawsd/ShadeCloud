...
object Scaffold : Module("Scaffold", Category.WORLD, Keyboard.KEY_I) {
    ...
    val scaffoldMode by choices( // added blocksmc mod 2025 7 05
        "ScaffoldMode", arrayOf("Normal", "Rewinside", "Expand", "Telly", "GodBridge", "BlocksMC"), "Normal"
    )
    ...
    // Add BlocksMC specific variables
    private val blocksMCGround by boolean("BlocksMCGround", true) { scaffoldMode == "BlocksMC" }
    private val blocksMCJumpHeight by float("BlocksMCJumpHeight", 0.42f, 0.1f..1.0f) { scaffoldMode == "BlocksMC" }
    private val blocksMCSpeed by float("BlocksMCSpeed", 0.47f, 0.1f..1.0f) { scaffoldMode == "BlocksMC" }
